...
protocol LookPointRecognizerDelegate {
    func lookAtPoint(_ point: CGPoint)
}

class LookPointRecognizer: NSObject {
    var delegate: LookPointRecognizerDelegate?
...
extension LookPointRecognizer: ARSCNViewDelegate {
